...
png('/Users/tbroiles/Dropbox/Coursera/Data_Science_Certification/Exploratory_Data_Analysis/Course_Project/Project2/plot5.png')

qplot(log(Emissions), data = motor_data[motor_data$fips == '24510',], facets = EI.Sector ~ year, xlab = 'Log Motor Emissions')
